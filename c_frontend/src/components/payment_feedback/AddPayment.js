  ...
  return (
    ...
    <div className="add-container">
      <div className="container bg-light d-md-flex align-items-center">
        ...
        <div className="card box2 shadow-sm" id="card2">
          {/* <div className="d-flex align-items-center justify-content-between p-md-5 p-4"> */}
            {/* <span className="h5 fw-bold m-0" id="form-title">Fill your payment details to confirm order !</span> */}
            {/* </div> */}
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="d-flex flex-column ps-md-5 px-md-0 px-4 mb-4">
                  <span id="input-label">Customer ID</span>
              ...
              <div className="col-12">
                <div className="d-flex flex-column px-md-5 px-4 mb-4">
                  ...
                  <div className="inputWithIcon1">
                    ...
                    <span className="form-check-label1">Credit Card</span>
                ...
                <div className="d-flex flex-column px-md-5 px-4 mb-4">
                   <span id="input-label">Card Number</span>
                  <div className="inputWithIcon">
                    <input className="form-control" type="text" name="cardnumber" maxLength="16" pattern="[0-9]{16}" title="Card number should consist with 16 digits!" placeholder="5136 1845 5468 3894" onChange={(e) => {
              ...
              <div className="col-md-6">
                <div className="d-flex flex-column ps-md-5 px-md-0 px-4 mb-4"> 
                <span id="input-label">Expiration<span className="ps-1">Date</span></span>
                  <div className="inputWithIcon">
              ...
              <div className="col-12 px-md-5 px-4 mt-3" id="btn-pay-contain">
